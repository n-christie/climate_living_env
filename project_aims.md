...
*Figure 1. Study area map showing three overlapping layers. **Background**: Skåne (light blue) within southern Sweden, with Denmark and Germany visible to the south and west; the surrounding water areas are the Øresund strait and the Baltic Sea. **Grid**: blue-outlined rectangles are the 54 ERA5 0.25° grid cells (~25 × 25 km each) covering Skåne — every RELOC-AGE residential address is assigned temperature data from the cell it falls in. **Stations**: filled circles are the 12 active SMHI ground weather stations within Skåne, coloured from yellow (cooler) to dark red (warmer) by their mean June–August daily maximum temperature averaged over 2010–2023. Coastal western stations (Malmö, Helsingborg, Falsterbo) are consistently 1–2 °C warmer in summer than inland and northern sites, reflecting urban heat and the moderating influence of Øresund. The hollow diamond (Hallands Väderö, italic label) is an SMHI station in the neighbouring county of Halland that monitors conditions just north of the Skåne border.*
